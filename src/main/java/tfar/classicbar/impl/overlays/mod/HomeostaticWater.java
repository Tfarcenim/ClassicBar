...
// Changed (MC 26.1 upgrade): Homeostatic compat replaced with a disabled stub because no 26.1
// build of the mod is available. The original implementation rendered a water/hydration bar
// driven by the homeostatic mod's API. All of that is removed; shouldRender() now always
// returns false so nothing is drawn. NAME is kept because ClassicBarsConfig still references it.
// Restore the full implementation once a 26.1-compatible Homeostatic build exists.
